...
#+begin_smaller
BIP generation algorithm == Prim's method for Minimum Spanning Tree
#+end_smaller
...
** Same orthogonality was observed



** vs Depth-based diversification : Improvements were observed in different domains
